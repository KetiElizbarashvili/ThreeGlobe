...
// blue 0x96ca6  ფუნქციაში შევცვალე 500ით და არ დამავიწყდეს
// green 0x9de3cb მგონი ესეც
...
DAT.Globe = function(container, opts) {
	...
	function addPoint(lat, lng, size, color, subgeo) {
		...
		point.scale.z = Math.max(size, 0.1); // მატრიცას ვიცილებ, უნდა გავარკვიო რამდენად სწორია
		point.updateMatrix();
